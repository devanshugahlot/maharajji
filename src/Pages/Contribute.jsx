                      ...
                      <fieldset>
                        <div className="row">
                          ...
                          <div className="col-sm-12 mb-3 sponsorship_type">
                            <div className="form-group">
                              <label htmlFor="amount">Sponsorship Type*</label>
                              <br />
                              <div>
                                <label className="radio-inline">
                                  <input
                          ...
                          <div className="col-sm-12 existing_sponsorship">
                            <div className="form-group">
                              <label htmlFor="category">Sponsorship ID*</label>
                              <input
                          ...
                          <div className="col-sm-12">
                            <div className="form-group">
                              ...
                              <p style={{ fontSize: 13, lineHeight: "1.4" }}>
                                Please check this if you are a taxpayer in India
                                and would like to avail tax benefits under 80G.
                                To avail this, you need to provide your PAN
                                number
                              </p>
                            </div>
                          </div>
